          ...
          {arrayImg.map((item) => (
            <div className="item" key={`carousel-${item.image}`}>
              ...
              <div className="content text-white">
                <div className="author text-base leading-6 xl:text-text-black mb-2">
                  TRADITIONAL
                </div>
                ...
                <div className="topic mb-3">
                  <p className="font-semibold text-base xl:text-text-black leading-6">
                    Characteristic
                  </p>
                  <p className="text-sm xl:text-text-gray leading-5">
                    {item.characteristic}
                  </p>
                </div>
                <div className="des">
